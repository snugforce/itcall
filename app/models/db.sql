...
CREATE TABLE tbl_usertask
(
	id INTEGER NOT NULL PRIMARY KEY AUTO_INCREMENT,	
	task_id INTEGER,
	user_id INTEGER,
	CONSTRAINT FK_usertask_user FOREIGN KEY (user_id)
		REFERENCES tbl_user (id) ON DELETE SET NULL ON UPDATE CASCADE,
	CONSTRAINT FK_usertask_status FOREIGN KEY (task_id)
		REFERENCES tbl_task (id) ON DELETE SET NULL ON UPDATE CASCADE	
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
